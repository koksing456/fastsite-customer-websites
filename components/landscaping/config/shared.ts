import { Service, WhyChooseUsData, SocialProofData, FAQItem } from "../types";
import { Award, Clock, Leaf, Shield, ThumbsUp, Users } from "lucide-react";

// Standard landscaping services that apply to all businesses
...
// Standard 'Why Choose Us' data that applies to all landscaping businesses
export const whyChooseUs: WhyChooseUsData = {
  title: "Why Choose Us",
  description:
    "With years of experience in landscaping excellence, we bring your garden dreams to life",
  features: [
    {
      icon: Clock,
      title: "Years of Experience",
      description:
        "Extensive experience creating beautiful landscapes across Malaysia.",
    },
    {
      icon: Leaf,
...
// Common FAQ items for landscaping businesses
