...
export default function KLGreenGardenPage() {
  return (
          ...
          <div className="container relative z-10 py-24 md:py-32 lg:py-40">
            <div className="max-w-2xl space-y-6 text-white">
              ...
              <p className="text-lg md:text-xl">
                KL Green Garden Landscape Work Studio creates beautiful,
                sustainable landscapes that enhance your property and lifestyle.
              </p>
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground text-lg">
                We offer comprehensive landscaping solutions tailored to your
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Efficient irrigation solutions to keep your landscape healthy while conserving water.",
                  image:
                ...
                },
                {
                  ...
                  description:
                    "Expert plant selection and installation to create vibrant, sustainable gardens.",
                  image:
                ...
                },
                {
                  ...
                  description:
                    "Enhance the beauty and security of your property with professional landscape lighting.",
                  image:
        ...
        <section id="portfolio" className="py-16 md:py-24">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground text-lg">
                Browse through our portfolio of completed landscape projects to
                get inspired.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                  About KL Green Garden
                </h2>
                <p className="text-lg text-muted-foreground">
                  KL Green Garden Landscape Work Studio has been creating
                  beautiful outdoor spaces for over 15 years. Our team of
                  experienced landscape designers and horticulturists are
                  passionate about transforming ordinary yards into
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  time: "2 years ago",
                  quote:
                    "Good service and fast response. Happy with the plants I received",
                },
                {
                  name: "Sophia Kaur",
                  role: "Customer",
                  time: "9 months ago",
                  quote:
                    "Excellent landscaping service. Very professional and attentive to details.",
                },
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        info@klgreengarden.com
                      </p>
                      <p className="text-muted-foreground">
                        Website: klgreengarden.com
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        12-08, Tower 2, 3 Towers, 349, Jln Ampang,
                      </p>
                      <p className="text-muted-foreground">
      ...
      <footer className="bg-gray-900 text-gray-300">
        <div className="container py-12">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
            <p>
              &copy; {new Date().getFullYear()} KL Green Garden Landscape Work
